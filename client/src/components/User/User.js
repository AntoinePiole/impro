...
import { Button, ButtonGroup, View, FormGroup, ControlLabel, FormControl } from "react-bootstrap";
        ...
        if (this.state.editting) {
            ...
            return(
                <div className="User">
                    ...
                    <p> Date de naissance : {this.state.birthday===""? 'Non renseignée': Moment(this.state.birthday).format('l')
                        }
                    </p>
                    <p> Pseudonyme : {this.state.username===""? 'Non renseigné' : this.state.username
                        }
                    </p>
                    <p> Tél. : {this.state.phone===""? 'Non renseigné': this.state.phone
                        }
                    </p>
                    <p> Email : {this.state.email===""? 'Non renseigné': this.state.email
                        }
                    </p>
                    <div className = 'userDescription'> Bio : {this.state.desc===""? 'Non renseigné': this.state.desc
                        }
                    </div>
